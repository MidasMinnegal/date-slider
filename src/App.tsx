...
function App() {
  ...
  const handlePointerMove = (e: React.PointerEvent<HTMLDivElement>) => {
    ...
    if (headerTextRef.current) {
      ...
      const isMarkerNearText = marker && marker.position.y <= 120;
      setHideHeaderText(isOverText || isMarkerNearText);
    }
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          pointerEvents: 'none',
          zIndex: 4,
          opacity: hideHeaderText ? 0 : 1,
          transition: 'opacity 0.2s ease'
        }}
      >
        Change the slider size to increase or decrease the range
      </div>
      ...
      <style>{`
        ...
        .reset-button::before {
          ...
          width: 100%;
          height: 200%;
          background: linear-gradient(to bottom, #ffffff 0%, #ffffff 66%, #e8e8e8 100%);
        ...
        .github-button::before {
          ...
          width: 100%;
          height: 200%;
          background: linear-gradient(to bottom, #000000 0%, #000000 66%, #6a6a6a 100%);
          transform: translateY(-50%);
          transition: transform 0.3s ease;
          z-index: 0;
        }
